...
/// @brief communicate the configuration data to the device using this nonblocking function
...
bool send_communications_nonblocking(const void* data, uint32_t size);
